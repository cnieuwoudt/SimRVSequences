---
title: "Formatting vcf Files for SimRVSequences"
...
```{r}
#store as dataframe and create colID variable to identify the column positon of the mutation
...
SNVdata_chrom22 <- SNVdata(list(Haplotypes = Haplotypes, Mutations = Mutations))
