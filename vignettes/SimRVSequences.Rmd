...
2. Founder haplotypes are sampled from a user-specified, population distribution of haplotypes conditioned on their cRV status.
    + For the founder who introduce the cRV we sample one haplotype from haplotypes that carry the familial cRV and another from the haplotypes that do not carry ANY of the cRVs in our pool of causal cRVs.  Hence, this founder may introduce only a single copy of the familial cRV.
    + For the founders who do NOT introduce a cRV we sample their haplotypes from the haplotypes that do not carry ANY of the cRVs in our pool of causal cRVs. Hence, fully sporadic families will not segregate any cRVs, nor will any non-carrier, marry-ins in our genetic families.  
...
3. (top-to-bottom/forwards-in-time approach) For each parent/offspring pair:
    ...
    2. perform conditional gene drop 
3. For each parent/offspring pair:
    ...
    4. perform conditional gene drop (described in ...) 
