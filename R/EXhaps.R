...
#'
#' @format A sparseMatrix (formal class dgCMatrix) with 20000 rows and 173 variables.  Each row is the haplotype for 1 diploid individual, each column represents a single SNV locus.  Each column in \code{EXhaps} is described by a row in \code{\link{EXmuts}}.
"EXhaps"
