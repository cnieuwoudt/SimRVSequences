...
#' \describe{
#'  \item{marker}{(OPTIONAL) An identifying name/number for the variant. (If missing this field will be automatically generated from the columns named "chrom" and "position" as "chrom_position").}
#'  \item{chrom}{The number of the chromosome on which the variant resides.}
